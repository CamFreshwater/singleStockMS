...
The structure of operating model is largely identical to that in Freshwater et al. 2019 [-FreshwaterSub] and is described in detail in Appendix S1. Briefly the dynamics of each Fraser River stock were simulated using an age-structured, Ricker spawner-recruit model [@Ricker1975]
