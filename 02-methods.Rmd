...
The simulation model is available in the _samSim_ package (available at https://github.com/CamFreshwater/samSim) and the code necessary to run the analyses are available at https://github.com/CamFreshwater/singleStockMS.