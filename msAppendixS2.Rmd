...
csas_table(sensPars,
  caption = "Table S2.1. Parameter values for components of operating model and management procedure that were adjusted in sensitivity analyses.",
  font_size = 12,
