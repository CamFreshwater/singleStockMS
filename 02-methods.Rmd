...
We parameterized the operating models that were used to forward simulate stock dynamics in the analysis by fitting stock-recruit models (details below) to observed spawner and recruit abundance data. Pacific Salmon Commission and DFO stock assessment biologists perform annual run reconstructions, which use observed escapement, catch, and age composition data allocated to individual stocks based on microsatellite stock identification to generate estimates of abundance (reviewed in detail in Grant [-@Grant2011]). 
