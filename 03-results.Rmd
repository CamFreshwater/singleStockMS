...
Fully mixed-stock fisheries maximized neither catch nor conservation performance. Intermediate allocations, for example splitting total allowable catch evenly between mixed- and single-stock fisheries, led to high median catches and relatively high median return abundance (`r recDecline`% decline relative to fully single-stock fisheries; Fig. \@ref(fig:aggTO)a) and the mean proportion of stocks above their conservation benchmark (`r ppnDecline`% decline; Fig. \@ref(fig:aggTO)b). Although conservation performance  fully single-stock fisheries.
