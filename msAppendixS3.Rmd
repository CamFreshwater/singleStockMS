...
The effects of greater variability differed among stochastic parameters and performance metrics. Greater temporal autocorrelation in recruitment deviations led to declines in recruitment, escapement, the proportion of stocks above their biological benchmark, and catch (Fig. S3.1). Such patterns are likely due to temporal autocorrelation weakening compensatory biological and management processes. Increasing or decreasing the observation error associated with estimates of spawner abundance had negligible impacts on all performance metrics (Fig. S3.1). Increasing outcome uncertainty, particularly within mixed-stock fisheries had the strongest impact, with greater deviations between realized and target catch resulting in reduced performance across all conservation and catch metrics (Fig. S3.1). Such patterns are consistent with evidence that outcome uncertainty can negatively affect conservation and harvest objectives [@Holt2006]. Single-stock outcome uncertainty exhibited a weaker effect due to intermittent closures and lower mean target exploitation rates (Fig. S3.1).Changes in interannual variability in maturation age and en route mortality rates had relatively minor effects on all performance metrics. 
