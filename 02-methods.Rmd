...
The structure of the operating model is equivalent to that in Freshwater et al. (in press) and is described in detail in Appendix S1. Briefly the dynamics of each Fraser River stock were simulated using an age-structured, Ricker spawner-recruit model [@Ricker1975]
