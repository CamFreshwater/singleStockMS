...
```{r genHCR, warnings=FALSE, messages=FALSE, fig.cap="Figure S1. Generic, abundance-based harvest control rule used to calculate target exploitation rates. Dashed vertical lines represent lower (red) and upper (green) fishery reference points equivalent to $0.4{S}_{MSY}$ and $0.8{S}_{MSY}$, respectively. The maximum exploitation rate is equal to ${u}_{MSY}$. The inflection point in exploitation rate does not fall on the lower fishery reference point because we assumed that an exploitation rate less than 0.1 was not feasible given incidental harvest in other fisheries."}
