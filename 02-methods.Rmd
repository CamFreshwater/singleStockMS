...
where $i$ represents a stock, $y$ a given brood year, $R$ the number of recruits, and $S$ the number of spawners. $\alpha$ represents the number of recruits produced per spawner at low abundance (in log space), while $\beta$ is the density-dependent parameter (i.e. the reciprocal of spawner abundance maximizing recruitment). Recruitment deviations $w_{i,y}$ are normally distributed with mean 0 and variance $\sigma^2$.
